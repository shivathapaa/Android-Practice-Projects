...
fun HomeScreen(
    ...
    var openAddTodoDialog = remember { mutableStateOf(false) }
        ...
        AnimatedContent(targetState = showTodo, label = "TodoNoteSwitch") { isTodoVisible ->
            when (isTodoVisible) {
                true -> TodoScreen(
                    ...
                    openAddTodoDialog = openAddTodoDialog.value,
                    onAddTodoClose = { openAddTodoDialog.value = false }
                )
